    ...
    <footer className="relative w-full bg-black text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1920px] mx-auto px-6 md:px-12 lg:px-[140px] py-16 md:py-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-8 items-start justify-items-center">
          ...
          <div className="w-full space-y-8 lg:order-1 order-1 justify-self-start">
            ...
            <div className="col-span-2 sm:col-span-1 mt-4 sm:mt-0">
              <div className="w-full bg-white/5 backdrop-blur-sm rounded-[30px] border border-white/10 p-6 space-y-4">
                <div className="space-y-4">
          ...
          {/* Center Column (Desktop): Logo */}
          <div className="w-full flex items-center justify-center lg:py-0 lg:order-2 order-3 justify-self-center">
            <img
          ...
          {/* Right Column: Nav Grid + Form */}
          <div className="w-full lg:order-3 order-2 justify-self-end">
            {/* Nav Columns */}
...
function SocialIcon({ icon, href }: { icon: 'facebook' | 'x' | 'instagram' | 'gmail', href: string }) {
  // Brand colors map
  const colors = {
    facebook: 'hover:bg-[#1877F2]',
    x: 'hover:bg-black',
    instagram: 'hover:bg-gradient-to-tr hover:from-[#833AB4] hover:via-[#FD1D1D] hover:to-[#F77737]', // Instagram Gradient
    gmail: 'hover:bg-[#EA4335]'
  };
  ...
  return (
    <a
      href={href}
      className={`w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white transition-all duration-300 hover:scale-110 hover:shadow-[0_0_15px_rgba(255,255,255,0.3)] group ${colors[icon]}`}
    >
