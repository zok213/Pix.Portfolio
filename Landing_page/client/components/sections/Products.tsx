  ...
  return (
    ...
    >
      ...
      <div className="relative z-[5] w-full max-w-[1600px] mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="flex flex-col items-center lg:hidden">
          ...
          >
            <h2 className="flex flex-col items-center">
              <span
                className="text-6xl md:text-8xl font-bold uppercase leading-none mb-2 drop-shadow-[0_0_20px_rgba(29,115,243,0.5)]"
                style={{
              ...
              <span
                className="text-5xl md:text-7xl font-bold uppercase leading-none text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.3)]"
                style={{
                  fontFamily: typography.fontFamily.ptSans,
                  letterSpacing: '0.1em',
                }}
          ...
          <div className="w-full flex flex-col items-center gap-24">
            ...
            <div className="w-full flex flex-col items-center">
              <motion.div
                ...
                viewport={{ once: true }}
                className="relative mb-8 max-w-[565px]"
              >
                ...
                <div className="relative h-16 px-12 rounded-full bg-black flex items-center justify-center overflow-hidden">
                  <span
                    className="text-white text-2xl font-bold uppercase tracking-widest relative z-10 drop-shadow-md"
              ...
              <motion.p
                ...
                viewport={{ once: true }}
                className="text-white/90 text-xl font-normal text-center leading-relaxed max-w-[800px]"
        ...
        {/* ==================== DESKTOP LAYOUT (hidden lg:grid) ==================== */}
        <div className="hidden lg:grid grid-cols-2 gap-x-20 gap-y-32 items-start pt-12">
          ...
          <div className="col-span-2 mb-12">
            ...
            >
              <h2 className="flex flex-col items-start">
                <span
                  className="text-[100px] xl:text-[128px] font-bold uppercase leading-none mb-2 drop-shadow-[0_0_20px_rgba(29,115,243,0.5)]"
                  style={{
                    fontFamily: typography.fontFamily.ptSans,
                    background: 'linear-gradient(180deg, rgba(29, 115, 243, 1) 0%, rgba(151, 71, 255, 1) 100%)',
                    WebkitBackgroundClip: 'text',
                ...
                <span
                  className="text-[80px] xl:text-[96px] font-bold uppercase leading-none text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.3)]"
                  style={{
                    fontFamily: typography.fontFamily.ptSans,
                    letterSpacing: '0.1em',
                  }}
          ...
          {/* Row 2: Pixity (Left: Info, Right: Image) */}
          <div className="flex flex-col items-start gap-8 max-w-[600px]">
            <motion.div
              initial={{ opacity: 0, x: -30 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="relative w-full max-w-[565px]"
            >
              <div className="absolute -inset-[2px] rounded-full bg-gradient-to-r from-blue-600 via-cyan-400 to-blue-600 opacity-70 blur-[1px]" />
              <div className="relative h-20 px-12 rounded-full bg-black flex items-center justify-center overflow-hidden">
                <span
                  className="text-white text-4xl font-bold uppercase tracking-widest relative z-10 drop-shadow-md"
                  style={{ fontFamily: typography.fontFamily.ptSans }}
                >
                  PIXITY
                </span>
            ...
            <motion.p
              ...
              whileInView={{ opacity: 1 }}
              viewport={{ once: true }}
              className="text-white/90 text-2xl font-normal leading-relaxed text-left"
              style={{ fontFamily: typography.fontFamily.inter }}
            >
              A smart AI assistant (real-time chatbox) that uses deep local knowledge to authentically connect brands with digital-native audiences.
            </motion.p>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="w-full aspect-video rounded-[30px] overflow-hidden shadow-[0_0_50px_rgba(29,115,243,0.3)] border border-white/10"
          >
            <img
              src="/images/product-our-product2.png"
              alt="PIXITY - AI Assistant Product"
          ...
          {/* Row 3: Crafterse (Left: Info, Right: Image) */}
          <div className="flex flex-col items-start gap-8 max-w-[600px]">
            <motion.div
              initial={{ opacity: 0, x: -30 }}
              whileInView={{ opacity: 1, x: 0 }}
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="w-full aspect-video rounded-[30px] overflow-hidden shadow-[0_0_50px_rgba(151,71,255,0.3)] border border-white/10"
          >
            <img
              src="/images/product-launcher.png"
              alt="Crafterse - 2D Action-RPG Game"
