          ...
          >
            <div className="relative inline-block">
              <h2
                ...
                style={{ fontFamily: typography.fontFamily.ptSans }}
              >
                OUR<br className="md:hidden" /> COMMUNITIES
              </h2>

              {/* Telegram Icon - Flying Position */}
              <div
                className="absolute top-8 -right-4 md:-top-8 md:-right-12 size-10 md:size-16 flex-shrink-0 cursor-pointer group"
                onClick={() => window.open('https://t.me/pix_lab', '_blank')}
              >
                <div className="absolute inset-0 bg-blue-500/30 rounded-full blur-lg animate-pulse group-hover:bg-blue-500/50 transition-colors duration-300" />
                <svg
                  width="100%"
                  height="100%"
                  viewBox="0 0 84 75"
                  ...
                  className="relative z-10 transition-transform duration-300 group-hover:scale-110 -rotate-12 group-hover:rotate-0"
                >
